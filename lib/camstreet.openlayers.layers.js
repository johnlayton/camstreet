  ...
  ol.control.LayersControl.prototype.setMap = function(map) {
    ...
    if(!goog.isNull(map)) {
      ...
      map.getLayers().forEach( function ( layer ) {
        ...
        cb.type = "checkbox";
        cb.innerHTML = "Visible";

        var lb = goog.dom.createDom(goog.dom.TagName.LABEL, ["", ol.css.CLASS_UNSELECTABLE], cb);
        ...
        var li = goog.dom.createDom(goog.dom.TagName.LI, ["", ol.css.CLASS_UNSELECTABLE], sp, fs);
