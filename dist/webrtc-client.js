...
function WebRTC(opts) {
    var self = this,
        ...
        config = this.config = {
          ...
          //logger.log("http://" + document.location.hostname + ":8080/conference");
    ...
    logger.log(this.config.url);
    connection = this.connection = io.connect(this.config.url, { transports: ['websocket'] });
