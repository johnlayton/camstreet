L.AgsDynamicLayer = L.Class.extend( {
  ...
  _getImageUrl: function ()
  {
    ...
    var bbox = 'bbox=' + bnds.getSouthEast().lng + ',' + bnds.getSouthEast().lat +
    ...
    var url = this._url + '/export?' + bbox + size + format + transparent +
              '&f=image';
  ...
  _updateLayer: function ()
  {
    if ( !this._image.updating )
    {
      ...
      //            hang the info on the image, we'll actually update it onload to make sure we don't
      //            reposition it before the new image comes down
